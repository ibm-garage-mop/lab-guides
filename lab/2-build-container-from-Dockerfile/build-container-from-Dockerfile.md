...
3. The git field contains the URI to the remote Git repository of the source code, to check out a specific Git, replace the line ´ref: ubi8´ by `ref: v1.0` after the `uri: 'https://github.com/geoffrey-pascal/sushiweb'`. This branch contains the new development version of Sushiweb, click `Save`
